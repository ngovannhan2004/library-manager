<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true"
    ...
    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(auth()->user()->checkAllow($menu['name']) || (isset($menu['type']) && $menu['type'] == 'public')): ?>
            <div data-kt-menu-trigger="click"
                 class="menu-item menu-accordion <?php if( $menu_parent == $menu['name']): ?> hover show  <?php endif; ?> ">
                <!--begin:Menu link-->
                ...
                <?php if(isset($menu['children']) && count($menu['children']) > 0): ?>
                    <div class="menu-sub menu-sub-accordion " kt-hidden-height="121" style="">
                        <?php $__currentLoopData = $menu['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!--begin:Menu item-->
                            <?php if(isset($item['gate'])): ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($item['gate'])): ?>
                                    <div class="menu-item ">
                                        <!--begin:Menu link-->
                                        <a class="menu-link <?php if($menu_parent == $menu['name'] && $menu_child == $item['name']): ?> active <?php endif; ?> "
                                           href="<?php if(isset($item['route'])): ?> <?php echo e(route($item['route'])); ?> <?php else: ?> # <?php endif; ?>">
                                ...
                                <?php endif; ?>
                            <?php elseif(auth()->user()->checkAllow($menu['name']) || (isset($item['type']) && $item['type'] == 'public')): ?>
                            <div class="menu-item ">
                                <!--begin:Menu link-->
                                <a class="menu-link <?php if($menu_parent == $menu['name'] && $menu_child == $item['name']): ?> active <?php endif; ?> "
                                   href="<?php if(isset($item['route'])): ?> <?php echo e(route($item['route'])); ?> <?php else: ?> # <?php endif; ?>">
...
<?php /**PATH F:\web\library\resources\views/admin/includes/menus.blade.php ENDPATH**/ ?>