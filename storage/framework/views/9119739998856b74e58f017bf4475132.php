<?php $__env->startSection('title_page'); ?>
    Create User - Admin - <?php echo e(config('app.name')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-10">
            ...
            <select name="role" class="form-control form-control-solid">
                <option value="admin" <?php echo e(old('') === 'admin' ? 'selected' : ''); ?>>Admin</option>
                <option value="user" <?php echo e(old('') === 'user' ? 'selected' : ''); ?>>User</option>
            </select>
        </div>
        <div class="mb-10">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\web\library\resources\views/admin/pages/user/create.blade.php ENDPATH**/ ?>