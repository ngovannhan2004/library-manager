...
<?php $__env->startSection('actions_layout'); ?>
    <a href="<?php echo e(route('admin.conditions.create')); ?>" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
...
<?php $__env->startSection('content_card'); ?>
    <div class="table-responsive">
        <table id="kt_datatable_horizontal_scroll" class="table table-row-dashed gy-5 gs-7">
            ...
            <tbody>
            <?php $__currentLoopData = $conditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td>
