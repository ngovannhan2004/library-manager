...
<?php $__env->startSection('actions_layout'); ?>
    <a href="<?php echo e(route('admin.statuses.index')); ?>" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
...
<?php $__env->startSection('content_card'); ?>
    <form action="<?php echo e(route('admin.statuses.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="mb-10">
