<?php $__env->startSection('title_page'); ?>
    List Category - Admin - <?php echo e(config('app.name')); ?>
...
<?php $__env->startSection('actions_layout'); ?>
    <a href="<?php echo e(route('admin.categories.create')); ?>" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($category->deleted_at == null): ?>
                            <a href="<?php echo e(route('admin.categories.delete', $category->id)); ?>"
                               class="btn btn-sm btn-clean btn-icon btn-icon-md btn-circle btn-danger" title="Delete">
                                <i class="fa fa-trash"></i>
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('admin.categories.restore', $category->id)); ?>"
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\web\library\resources\views/admin/pages/category/index.blade.php ENDPATH**/ ?>