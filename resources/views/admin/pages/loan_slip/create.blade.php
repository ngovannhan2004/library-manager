...
@section('title_page')
    Create Loan Slip - Admin - {{ config('app.name') }}
@endsection
@section('name_user')
    {{auth()->user()->name}}
...
@section('content_card')
    ...
    @endif
    <form action="{{ route('admin.loan_slips.store') }}" method="post" class="form-control-sm">
        @csrf
        <div class="mb-10">
                            ...
                            <div class="mb-10">
                                ...
                                <select name="publisher_id" class="form-select form-select-solid" data-control="select2"
                                    ...
                                    @foreach($publishing_companies as $publishing_company)
                                        <option
                                            value="{{ $publishing_company->id }}">{{ $publishing_company->name }}</option>
